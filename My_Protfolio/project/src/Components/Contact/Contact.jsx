    ...
    <section className="contact section" id="contact">
      ...
      <div className="contact__container container grid">
        <div className="contact__content">
          <h3 className="contact__title">Have A Chat With Me</h3>
          <div className="contact__info">
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">9974598215</span>
              <a
                href="https://wa.me/919974598215"
                className="contact__button"
                target="_blank"
            ...
            <div className="contact__card">
              ...
              <span className="contact__card-data">Aymaan Pathan</span>
              <a
        ...
        <div className="contact__content">
          <h3 className="contact__title">Write Me Some Good Ideas</h3>
          <form className="contact__form">
            ...
            <button className="contact-button " onClick={handleForm}>
              Send Message
              <svg
                className="contact-button_icon"
